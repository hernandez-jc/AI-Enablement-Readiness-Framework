...
Un uso para generar ideas preliminares puede requerir controles diferentes de un sistema utilizado para apoyar decisiones con consecuencias importantes.
...
| ---------------------------------------- | ----------------------------------------------------------------- |
| Uso exploratorio                         | Orientación básica y uso de herramientas autorizadas              |
| Productividad interna                    | Políticas de uso, protección de información y revisión            |
| Automatización de procesos               | Controles operativos, pruebas y supervisión                       |
| Soporte a decisiones                     | Validación, trazabilidad y supervisión humana                     |
| Decisiones de alto impacto               | Evaluación reforzada de riesgo, controles y responsabilidades     |
| Sistemas integrados en procesos críticos | Gobernanza continua, monitoreo y gestión formal del ciclo de vida |
...
La aplicación de assessment analiza la gobernanza mediante diez criterios.

| ID     | Elemento evaluado                     | Qué busca determinar                                                |
| ------ | ------------------------------------- | ------------------------------------------------------------------- |
| GOV-01 | Estrategia y principios               | Si existen principios claros para orientar el uso de IA             |
| GOV-02 | Políticas de uso                      | Si existen reglas claras sobre usos permitidos y restringidos       |
| GOV-03 | Roles y responsabilidades             | Si está definido quién decide, supervisa y responde                 |
| GOV-04 | Evaluación de riesgos                 | Si los riesgos se identifican y valoran antes del uso               |
| GOV-05 | Supervisión humana                    | Si existe intervención humana apropiada según el riesgo             |
| GOV-06 | Privacidad y seguridad                | Si existen controles para proteger información y sistemas           |
| GOV-07 | Transparencia y trazabilidad          | Si puede comprenderse y documentarse el uso de IA                   |
| GOV-08 | Gestión de proveedores y herramientas | Si las soluciones externas se evalúan antes de utilizarse           |
| GOV-09 | Monitoreo y control                   | Si los sistemas se supervisan después de su implementación          |
| GOV-10 | Gestión del ciclo de vida             | Si existen mecanismos para revisar, actualizar o retirar soluciones |
...
No basta con publicar una política.
...
| Actividad               | Usuario | Líder | Tecnología | Datos | Riesgo / Cumplimiento |
| ----------------------- | ------- | ----- | ---------- | ----- | --------------------- |
| Identificar oportunidad | R       | A     | C          | C     | C                     |
| Evaluar datos           | C       | C     | C          | R/A   | C                     |
...
| ----: | ------------- | -------------------------------------------------------------- |
|     1 | Inicial       | Existen controles mínimos o no existe un enfoque definido      |
|     2 | En desarrollo | Existen iniciativas parciales o inconsistentes                 |
|     3 | Definida      | Existen políticas, roles y procesos básicos documentados       |
|     4 | Gestionada    | Los controles se aplican de manera consistente y se supervisan |
|     5 | Optimizada    | La gobernanza está integrada, medida y mejora continuamente    |
...
| -------------------------------------- | -------------------- |
| Existe una política                    | Capacidad formal     |
| Los usuarios conocen la política       | Conocimiento         |
| Los usuarios pueden interpretarla      | Comprensión          |
| Los usuarios la aplican correctamente  | Capacidad            |
| La organización verifica su aplicación | Control              |
| Los controles producen mejoras         | Capacidad gestionada |
...
| Situación observada                                      | Posible causa        | Intervención          |
| -------------------------------------------------------- | -------------------- | --------------------- |
| Los usuarios desconocen las reglas                       | Conocimiento         | Formación             |
| Los usuarios conocen las reglas pero no saben aplicarlas | Habilidad            | Casos y simulaciones  |
| Las reglas son ambiguas                                  | Política             | Revisión normativa    |
| Nadie sabe quién decide                                  | Responsabilidad      | Definición de roles   |
| No existen controles                                     | Gobernanza           | Diseño de controles   |
| Las herramientas no están autorizadas                    | Tecnología / gestión | Proceso de aprobación |
...
| --------------- | ------------------------------------------------------------------- |
| Bajo            | Principios básicos y uso responsable                                |
| Medio           | Aplicación de políticas y evaluación de escenarios                  |
| Alto            | Evaluación formal, controles y supervisión                          |
| Crítico         | Capacidades especializadas y responsabilidades claramente definidas |
...
| Elemento           | Ejemplo                                             |
| ------------------ | --------------------------------------------------- |
| Brecha             | Los usuarios no identifican información restringida |
| Capacidad objetivo | Clasificar información antes de utilizar IA         |
| Conocimiento       | Categorías de información y reglas                  |
| Habilidad          | Identificación y clasificación                      |
| Práctica           | Casos de decisión                                   |
...
| Necesidad                    | Actividad                   |
| ---------------------------- | --------------------------- |
| Conocer políticas            | Microlearning               |
| Interpretar políticas        | Casos prácticos             |
| Reconocer riesgos            | Simulaciones                |
| Aplicar controles            | Taller basado en escenarios |
| Evaluar casos de uso         | Workshop interdisciplinario |
| Tomar decisiones             | Ejercicios de juicio        |
| Supervisar resultados        | Laboratorio de evaluación   |
| Comprender responsabilidades | Taller de roles             |
...
Una gobernanza clara también puede acelerar la adopción.
...
| Dimensión      | Relación                                                 |
| -------------- | -------------------------------------------------------- |
| **Datos**      | Define condiciones para acceder y utilizar información   |
| **Skills**     | Desarrolla la capacidad de aplicar políticas y controles |
| **Tecnología** | Permite implementar controles técnicos                   |
| **Procesos**   | Integra controles dentro del trabajo cotidiano           |
| **Cultura**    | Influye en la aceptación y cumplimiento de las reglas    |
| **Estrategia** | Define prioridades y tolerancia al riesgo                |
...
Volver al inicio del framework
